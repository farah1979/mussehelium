<h1 align="center">Milestone First Project:User Centric Web Design</h1>
<h1 align="center">Maxi & Helium</h1>
...
<img src="assets/images/responsivedesign-project.png">
...
- Returning Visitor Goals
  ...
  2. To contact with us to stay informed of any current new changes.
...
- Frequent User Goals
  1. I want to check to see if there are any newly books added. 
  2. I want to benefit more from reading books and learning lessons from them.
...
### Wireframes
- Home Page Wireframe - This is the main page, all pages contains the same 
1- Header (Navbar) and Footer.The Header (Navbar)used to navigate smothly through the diferents pages and the (book Nav in the Header has drowpdown menu to navigate easily between the diferents books). 
2- The Footer. It has the Contact personal information about the author Camilla Brick, link to navigate through the pages and Social Media links.

<img src="assets/images/wireframe-home.png">

- Book page Wireframe - This is the book page which can see all the Maxi and Helium Book Stories, the user can click on one of them and read about the book.

<img src="assets/images/wireframe-book.png">

- Author page Wireframe- This is the author page, which can the visitor know more information about the author Camilla Brinck.

<img src="assets/images/wireframe-author.png">

- Contact Page Wireframe- This is the contact page, which can any visitor contact with the author and they can leave any feedback about the books.

<img src="assets/images/wireframe-contact.png">

- Mobile Wireframe- This is the mobile version about the project.
...
# Technologies
## Languages Used
 - HTML5: Hypertext Markup Language.[View HTML5](https://en.wikipedia.org/wiki/HTML5)
 - CSS3 : Cascading Style Sheets.[View CSS3](https://en.wikipedia.org/wiki/CSS#CSS_3)
...
- I have used the **W3C Html Coding Validator** and the **W3C CSS Validator** on my project to validate every page of 
...
*Internet 10* and *Avast Secure Browser*, in addition to *mobile sizes and iPad*.

- I could test the Header(navbar) Menu and allows to access to each individual page successfully, the Footer, throught the contact information its allows call and/ or send Email to the author successful, the Social Media allows to open new pages successful with the own link.
I have tested the carousel images in the main page and its work successful.

- Responsive Design for all pages.


- W3C Markup Validator - Results <img src="assets/images/home-validat.png">

- W3C CSS Validator - Results    <img src="assets/images/css-validat.png">

## Testing User Stories from User Experience (UX) Section
### Visitor Goals
First time visitor, he can understand the main purpose of this site by looking at the books first and secondly through the link on the books page, which he can click and open a file for him on a new page that contains all the information and what are the benefits of reading for children.

Can easily navicate between pages through the Navbar Menu in the Header and he/she can easily move between the books placed on the home page through the book link and also on the books page by clicking on the book's picture.

The site has been designed to be fluid and never to entrap the user. At the top of each page there is a clean navigation bar, each link describes what the page they will end up at clearly.

The user can also scroll to the bottom of any page on the site to locate the conatat information about the author, links between pages and social media links in the footer.

The Facebook, Instagram, Linkedin, Twitter Pages can be found at the footer of every page and every one will open a new tab for the user 
and more information can be found on the Social pages.

The Youtube page can be found at the footer of every page and will open a new tab for the user 
and can find many videos about stories and the author Camilla Briinck, and he can also enjoy audio stories.
...
## Known Bugs
On some mobile devices the carousel Images pushes the size of screen out more than any of the other content on the page sometimes.
...
7- This is my publish website link (https://farah1979.github.io/mussehelium/)
